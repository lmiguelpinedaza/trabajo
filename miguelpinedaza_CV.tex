...
\address{Naucalpan}{Estado de México}% optional, remove / comment the line if not wanted; the "postcode city" and "country" arguments can be omitted or provided empty
...
\cventry{2020-8 \newline ...}{Instituto Mexicano de Desarrollo de Software}{Desarrollador}{}{}{
    %Achievements:%
    \begin{itemize}%
	\item Mantenimiento y administración de diferentes sitios web.
	\item Elaboración de páginas desde cero con Magento, Wordpress y código puro (HTML5, CSS, JavaScript).
	\item Consultar y consumir una API para procesar la respuesta.
	\item Auditorías de métricas como la primera vista y el tiempo de interacción para determinar el retraso.
	\item Comprobar si hay problemas comunes que pueden impedir que los usuarios accedan a su contenido.
	\item Mejorar la búsqueda de los elementos de la pagina web, desde el uso de HTTPS hasta las proporciones correctas de la imagen.
	\item Verifica las mejores prácticas para garantizar que su sitio sea detectable.
	\item Hacer el sitio responsivo para mobile, tablet y desktop.
	\item Progressive Web App para permitir difundir contenido sobre cualquier dispositivo.
...
\cventry{2019-11\newline 2020-6}{doto.com.mx}{Desarrollador Magento}{}{}{
    %Achievements:%
    \begin{itemize}%
	\item Mantenimiento y administración de la pagina web doto.com.mx desarrollando back-end y front-end.
	\item Migración de Magento 2.1 a Magento 2.3.
	\item Desarrollo y diseño de la página web desde cero.
	\item Auditoría de métricas como la primera vista y el tiempo de interacción para determinar el retraso.
	\item Comprobar si hay problemas comunes que pueden impedir que los usuarios accedan a su contenido.
	\item Mejorar la búsqueda de los elementos de la pagina web, desde el uso de HTTPS hasta las proporciones correctas de la imagen.
	\item Verifica las mejores prácticas para garantizar que el sitio sea detectable.
	\item Hacer el sitio responsivo para mobile, tablet y desktop.
	\item Progressive Web App para permitir difundir contenido sobre cualquier dispositivo.
	\item Generación de reportes del estado del pedido, tipo de venta y acceso de usuarios desde la base de datos con MySQL.
	    %\item Update of RPC-DAQ schematic for switched power supply.
	    %\item Test methodology development for RPC Test-jig, Pin-Assignment for FPGA, and schematic design.
	    %\item Design of LC ladder based sub-nanosecond stepped electronically controlled delay circuit.
    \end{itemize}}
...
\cventry{2019-8 \newline 2019-9}{Promociones y Display Marketing}{Sistemas y Soporte}{}{}{
	...
	\item Creación de formularios con macros para que sea más amigable el llenado de datos en Excel.
	\item Reportes y estadísticas con tablas dinámicas en Excel.
	    %\item Update of RPC-DAQ schematic for switched power supply.
	    %\item Test methodology development for RPC Test-jig, Pin-Assignment for FPGA, and schematic design.
	    %\item Design of LC ladder based sub-nanosecond stepped electronically controlled delay circuit.
    \end{itemize}}

\cventry{2016-6\newline 2016-8 2017-6\newline 2017-8}{McDonald's, Naucalpan, Méx}{Empleado General}{}{}{
    %Achievements:%
    \begin{itemize}%
	\item Conocimiento en cocina y atención al cliente.
	\item Encargado del área de cocina y entrega de pedido.
	    %\item Update of RPC-DAQ schematic for switched power supply.
	    %\item Test methodology development for RPC Test-jig, Pin-Assignment for FPGA, and schematic design.
	    %\item Design of LC ladder based sub-nanosecond stepped electronically controlled delay circuit.
    \end{itemize}}
...
\cventry{2015-2 \newline 2015-9}{Burger King M\'exico - Naucalpan, M\'ex}{Líder de producción}{}{}{
    %Achievements:%
    \begin{itemize}%
	\item Manejo de tiempos y temperaturas de la producción del producto así como la evaluación de empleados. Conocimiento en cocina y atención al cliente.
	    %\item Update of RPC-DAQ schematic for switched power supply.
	    %\item Test methodology development for RPC Test-jig, Pin-Assignment for FPGA, and schematic design.
	    %\item Design of LC ladder based sub-nanosecond stepped electronically controlled delay circuit.
    \end{itemize}}
