...
\cvitem{}{Conocimiento de lenguajes de programación: C, C++,  SQL, Python, Java, R (estadística), JavaScript, Html5, PHP y CSS; y manejo de Office (excel avanzado).}
    \cvitem{}{Uso de IDE: Netbeans, Notepad++, Sublime text y Visual Studio. Administración y configuración en plataformas de google (Google Console, Google Analytics, Google Trends, Google Ads, GTM, Google Optimize).}
